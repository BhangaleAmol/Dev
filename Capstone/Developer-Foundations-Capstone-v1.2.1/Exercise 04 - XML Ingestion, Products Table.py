...
df=df.select("product_id","color","model_name","model_number","price.*","size")
df=df.select("product_id","color","model_name","model_number",\
             (col("_base_price").alias("base_price")),\
             (col("_color_adj").alias("color_adj")),\
             (col("_size_adj").alias("size_adj")),\
             (col("usd").alias("price")),\
             "size")
df.write.format("delta").saveAsTable(products_table)
