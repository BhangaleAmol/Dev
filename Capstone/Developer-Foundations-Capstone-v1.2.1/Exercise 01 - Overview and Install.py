...
# MAGIC
# MAGIC This Capstone project was designed to work with Databricks Runtime Version (DBR) 9.1 Beta and the Databricks Community Edition's (CE) default cluster configuration. 
# MAGIC
# MAGIC When working in CE, start a default cluster, specify DBR **9.1 Beta**, and then proceede with the next step. 
# MAGIC
