...
file_name = file_name or "Product Division - GBU master file.xlsx"
sheet_name = sheet_name or 'Product Division'
table_name = table_name or "product_division_gbu_master"
...
main2 = (
  ...
  .transform(convert_null_to_unknown('ProductDivision'))
  .distinct()
)
...
show_duplicate_rows(main_f, 'ProductDivision')

# COMMAND ----------

key_columns = 'ProductDivision'

# COMMAND ----------

# DROP DUPLICATES
if key_columns is not None:
  main_f = main_f.dropDuplicates(['ProductDivision'])
else:
  main_f = main_f
