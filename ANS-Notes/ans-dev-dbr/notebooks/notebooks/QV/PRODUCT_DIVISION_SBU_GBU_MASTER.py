...
file_name = file_name or "Product Division - SBU - GBU master.xlsx"
sheet_name = sheet_name or 'Sheet1'
table_name = table_name or "product_division_sbu_gbu_master"
...
main2 = (
  ...
  .transform(convert_null_to_unknown('Region,NOTRegion,Division,ProductDivision,SBU,M4Family,GBU'))
  .distinct()
)
...
show_duplicate_rows(main_f, 'Region,NOTRegion,Division,ProductDivision,SBU,M4Family,GBU')

# COMMAND ----------

key_columns = 'Region,NOTRegion,Division,ProductDivision,SBU,M4Family,GBU'

# COMMAND ----------

# DROP DUPLICATES
if key_columns is not None:
  main_f = main_f.dropDuplicates(['Region','NOTRegion','Division','ProductDivision','SBU','M4Family','GBU'])
else:
  main_f = main_f
