...
file_name = file_name or "Product Master RINGERS for SBU.xlsx"
sheet_name = sheet_name or 'Product'
table_name = table_name or "product_master_ringers"
...
if key_columns is not None:
  ...
  if not duplicates.rdd.isEmpty():
    notebook_data = {
      ...
      'duplicates_sample': duplicates.select(['ProductNumber']).limit(50)
    }
...
# DROP DUPLICATES
if key_columns is not None:
  main_f = main_f.dropDuplicates(['ProductNumber'])
