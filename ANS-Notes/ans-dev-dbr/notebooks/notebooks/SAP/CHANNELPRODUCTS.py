...
file_name = file_name or "MLE_Channel_Products.csv"
table_name = table_name or "ChannelProducts"
handle_delete = False
header = False
...
main2 = (
  main
    ...
    .withColumnRenamed('_c1', 'ChannelId')
    .withColumnRenamed('_c2', 'MRPN')
    .withColumnRenamed('_c3', 'ProductDescription')
    .withColumn('_c4',f.regexp_replace('_c4',',','.'))
    .withColumnRenamed('_c4', 'AverageCost')
    .withColumnRenamed('_c5', 'IncrementValue')
    .withColumnRenamed('_c6', 'LeadTime')
    .withColumnRenamed('_c7', 'MinimumLotQty')
    .withColumnRenamed('_c8', 'OpenOrderFreezePeriod')
    .withColumnRenamed('_c9', 'RequirementsOffset')
    .withColumn('_c10',f.regexp_replace('_c10',',','.'))
    .withColumnRenamed('_c10', 'AverageSellingPrice')
    .withColumnRenamed('_c11', 'ShelfLife')
    .withColumnRenamed('_c12', 'Vendor')
    .withColumnRenamed('_c13', 'AlternateVendor')
    .withColumnRenamed('_c14', 'Profitability')
    .withColumnRenamed('_c15', 'VendorName')
    .withColumnRenamed('_c16', 'StyleCode')
