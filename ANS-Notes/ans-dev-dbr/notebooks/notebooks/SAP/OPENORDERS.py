...
file_name = file_name or "MLE_Open_Orders.csv"
table_name = table_name or "OpenOrders"
handle_delete = False
header = False
...
main2 = (
  main
    ...
    .withColumnRenamed('_c2', 'DueDate')
    .withColumnRenamed('_c3', 'goodsQty')
    .withColumnRenamed('_c4', 'CreationDate')
    .withColumnRenamed('_c5', 'originalQty')
    .withColumnRenamed('_c6', 'PONumber')
    .withColumnRenamed('_c7', 'ScheduleDate')
    .withColumnRenamed('_c8', 'SOURCE_REF')
    .withColumnRenamed('_c9', 'OriginalPONumber')
    .withColumnRenamed('_c10', 'vendor')
    .withColumnRenamed('_c11', 'vendorName')
    .withColumnRenamed('_c12', 'sourceWarehouse')
    .transform(fix_column_names)
    .transform(convert_nan_to_null)
    .transform(trim_all_values)
    .groupBy('ProductCode', 'ChannelId','DueDate','CreationDate','PONumber','ScheduleDate','SOURCE_REF','OriginalPONumber','vendor','vendorName','sourceWarehouse')
  .agg(f.sum("goodsQty").alias("goodsQty"),  
       f.sum("originalQty").alias("originalQty"))
)
