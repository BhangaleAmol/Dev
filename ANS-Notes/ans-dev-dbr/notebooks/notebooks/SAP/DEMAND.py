...
file_name = file_name or "MLE_Past_Future_Demand.csv"
table_name = table_name or "Demand"
handle_delete = False
header = False
...
main2 = (
  main
    ...
    .withColumnRenamed('_c2', 'LastDayOfMonth')
    .withColumnRenamed('_c3', 'HistoryType')
    .withColumnRenamed('_c4', 'Demand')
