...
# MAGIC %sql 
# MAGIC CREATE OR REPLACE VIEW g_fin_qv.wc_qv_gl4_a AS
# MAGIC SELECT
...
# MAGIC   GL.amountLocalCurrency TRANSACTION_AMOUNT_USD,
# MAGIC   GL.amountDocumentCurrency TRANSACTION_AMOUNT,
# MAGIC   GL.localCurrencyCode AS LEDGER_CURRENCY,
# MAGIC   GL.documentCurrencyCode AS TRANSACTION_CURRENCY,
...
# MAGIC   GL.lineDescription JE_LINE_DESCRIPTION
# MAGIC FROM
...
# MAGIC   AND LEDGER.NAME NOT IN ('MY GTC MYR Reporting','MX Local Ledger','IN PP Local Ledger')
