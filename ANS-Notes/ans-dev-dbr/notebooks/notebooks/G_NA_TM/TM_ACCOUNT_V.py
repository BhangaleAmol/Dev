...
# MAGIC %run ../_SCHEMA/g_na_tm.tm_account_v
...
table_name = get_input_param('table_name', default_value = 'tm_account_v')
...
# HANDLE DELETE
full_keys_f = (
   spark.table('s_core.account_agg')
  .select('_ID')
...
if not sampling:
  ...
  update_cutoff_value(cutoff_value, target_table, 's_core.account_agg')
  update_run_datetime(run_datetime, target_table, 's_core.account_agg')
