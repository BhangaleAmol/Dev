...
for i in range(1, 25):
  ...
  for c in main_4.columns:
    if c == f'SYSF{future_date.month}/{str(future_date.year)[2:]}':
      main_4 = main_4.withColumnRenamed(c, f'SYSF{i}')
    if c == f'RSLF{future_date.month}/{str(future_date.year)[2:]}':
      main_4 = main_4.withColumnRenamed(c, f'RSLF{i}')
    if c == f'FBGT{future_date.month}/{str(future_date.year)[2:]}':
      main_4 = main_4.withColumnRenamed(c, f'FBGT{i}')
    if c == f'FBGD{future_date.month}/{str(future_date.year)[2:]}':
      main_4 = main_4.withColumnRenamed(c, f'FBGD{i}')
    if c == f'AD1F{future_date.month}/{str(future_date.year)[2:]}':
      main_4 = main_4.withColumnRenamed(c, f'AD1F{i}')
    if c == f'AD3F{future_date.month}/{str(future_date.year)[2:]}':
      main_4 = main_4.withColumnRenamed(c, f'AD3F{i}')
    if c == f'UAF3{future_date.month}/{str(future_date.year)[2:]}':
      main_4 = main_4.withColumnRenamed(c, f'UAF3{i}')
    if c == f'MFCI{future_date.month}/{str(future_date.year)[2:]}':
      main_4 = main_4.withColumnRenamed(c, f'MFCI{i}')
