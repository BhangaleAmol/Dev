...
table_name = get_input_param('table_name', default_value = 'LOM_AA_DO_L4_HIST')
...
# EXTRACT
file_path = get_file_path(temp_folder, 'tmp_lom_aa_do_l4_hist.dlt')
TMP_LOM_AA_DO_L4_HIST = spark.read.format('delta').load(file_path)
TMP_LOM_AA_DO_L4_HIST.createOrReplaceTempView("TMP_LOM_AA_DO_L4_HIST")
...
# SAMPLING
if sampling:
  TMP_LOM_AA_DO_L4_HIST = TMP_LOM_AA_DO_L4_HIST.limit(10)
  TMP_LOM_AA_DO_L4_HIST.createOrReplaceTempView('TMP_LOM_AA_DO_L4_HIST')

# COMMAND ----------

TMP_LOM_AA_DO_L4_HIST.display()
...
# MAGIC %sql
# MAGIC select count(*) from g_tembo.lom_aa_do_l4_hist 
