...
key_columns = get_input_param('key_columns', 'string', default_value = 'Parent_Item_ID,Parent_Location,Component_Item_ID')
...
IP_PSL = spark.read.format('delta').load(file_path)
IP_PSL.createOrReplaceTempView("IP_PSL")
