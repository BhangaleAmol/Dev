...
table_name = get_input_param('table_name', default_value = 'IP_LOM_AA_L2_HIST')
...
# EXTRACT
file_path = get_file_path(temp_folder, 'tmp_ip_lom_aa_l2_hist.dlt')
TMP_IP_LOM_AA_L2 = spark.read.format('delta').load(file_path)
TMP_IP_LOM_AA_L2.createOrReplaceTempView("TMP_IP_LOM_AA_L2")
...
# SAMPLING
if sampling:
  TMP_IP_LOM_AA_L2 = TMP_IP_LOM_AA_L2.limit(10)
  TMP_IP_LOM_AA_L2.createOrReplaceTempView('IP_LOM_AA_L2')
...
# MAGIC %sql
# MAGIC select count(*) from g_tembo.ip_lom_aa_l2_hist
