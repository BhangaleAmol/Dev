...
if handle_delete:
  ...
  source_file_path_keys = get_file_path(source_folder_keys, f'{file_name}.par', target_container, target_storage)
  print('source_file_path_keys: ' + source_file_path_keys)
  
def_source_name = database_name.upper()
print('source_name: ' + def_source_name)
