...
main = spark.sql("""Select distinct
                    ...
                    CountryName AS countryDescription,
                    CountryName AS countryShortName,
                    'CO' AS euCode,
...
# HANDLE DELETE
full_keys_f = (
  spark.sql("""select Country AS countryCode 
              from  
...
if not test_run:
  ...
  update_cutoff_value(cutoff_value, table_name, 'tmb.dbo_E2Ecountries')
  update_run_datetime(run_datetime, table_name, 'tmb.dbo_E2Ecountries')
