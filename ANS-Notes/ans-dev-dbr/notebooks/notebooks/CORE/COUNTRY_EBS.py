...
main = spark.sql("""Select
                    ...
                    FND_TERRITORIES_TL.TERRITORY_CODE                                                AS countryCode,
                    FND_TERRITORIES_TL.DESCRIPTION                                                   AS countryDescription,
                    FND_TERRITORIES_TL.TERRITORY_SHORT_NAME                                          AS countryShortName,
