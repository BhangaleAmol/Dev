...
table_name = get_input_param('table_name', default_value = 'dim_engineer')
target_folder = get_input_param('target_folder', default_value = '/datalake_silver/ticketsystems/full_data')

# COMMAND ----------

# EXTRACT
main_f = spark.table('s_ticketsystems.dim_engineer_glpi')
...
merge_into_table(main_f, full_name, 'EngineerID', options = {'auto_merge': True})  
