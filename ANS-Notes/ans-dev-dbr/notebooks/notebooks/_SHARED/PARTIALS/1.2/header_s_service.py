...
database_name = get_json_param('config', 'database_name', "string", 's_service') 
...
metadata_folder = get_json_param('config', 'metadata_folder', 'string', '/datalake/s_service/metadata')
...
target_folder = get_json_param('config', 'target_folder', 'string', '/datalake/s_service/full_data')
target_storage = get_json_param('config', 'target_storage', 'string', 'edmans{env}data002')
temp_folder = get_json_param('config', 'temp_folder', 'string', '/datalake/s_service/temp_data')
