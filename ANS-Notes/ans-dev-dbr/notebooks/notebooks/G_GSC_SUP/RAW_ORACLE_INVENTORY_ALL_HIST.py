...
# MAGIC %run ../_SCHEMA/g_gsc_sup.raw_oracle_inventory_all_hist
...
table_name = get_input_param('table_name', default_value = 'raw_oracle_inventory_all_hist')
...
Select
    ...
    , inventory.inventoryDate AS TRANSDATE
...
Where 1=1
  ...
  and inventory.inventoryDate in (select last_day(inventoryDate) from  s_supplychain.inventory_agg Inventory where not _deleted)
