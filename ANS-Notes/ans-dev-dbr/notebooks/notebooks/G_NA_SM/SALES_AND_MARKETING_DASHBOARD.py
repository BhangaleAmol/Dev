...
# MAGIC %sql
# MAGIC Create database if not exists g_na_sm;

# COMMAND ----------

# MAGIC %sql
# MAGIC CREATE OR REPLACE VIEW g_na_sm.sm_operating_units_v
# MAGIC AS SELECT
# MAGIC _ID,
# MAGIC name,
...
# MAGIC
# MAGIC CREATE OR REPLACE VIEW g_na_sm.sm_inventory_units_v
# MAGIC AS SELECT
# MAGIC _ID,
# MAGIC name,
# MAGIC organizationCode,
...
# MAGIC AND not _DELETED;
# MAGIC
# MAGIC CREATE OR REPLACE VIEW g_na_sm.sm_accounts_v AS
# MAGIC select
# MAGIC    _ID,
# MAGIC   accountId,
# MAGIC   accountNumber,
...
# MAGIC
# MAGIC
# MAGIC CREATE OR REPLACE VIEW g_na_sm.sm_products_v
# MAGIC AS select
# MAGIC _ID,
# MAGIC ansStdUom,
# MAGIC ansStdUomConv,
...
# MAGIC AND not _DELETED;
# MAGIC
# MAGIC CREATE OR REPLACE VIEW g_na_sm.sm_parties_v
# MAGIC AS SELECT
# MAGIC _ID,
# MAGIC address1Line1,
# MAGIC address1Line2,
...
# MAGIC AND not _DELETED;
# MAGIC
# MAGIC -- CREATE OR REPLACE VIEW G_NA_SM.sm_order_types_v
# MAGIC CREATE OR REPLACE VIEW G_NA_SM.sm_return_types_v
# MAGIC AS
# MAGIC SELECT
# MAGIC   _ID,
# MAGIC   description,
...
# MAGIC FROM
# MAGIC   S_CORE.TRANSACTION_TYPE_AGG ot
# MAGIC WHERE
# MAGIC   _SOURCE = 'EBS'
# MAGIC   AND TRANSACTIONGROUP IN ('unknown', 'ORDER_TYPE')
# MAGIC AND (upper(ot.description) like '%RMA%'
# MAGIC     OR upper(ot.description) like '%RETURN%'
# MAGIC     OR upper(ot.description) like '%CREDIT%')
# MAGIC   AND NOT _DELETED;
# MAGIC   
# MAGIC CREATE OR REPLACE VIEW G_NA_SM.sm_order_types_v AS
# MAGIC select
# MAGIC   _ID,
# MAGIC   description,
# MAGIC   name,
...
# MAGIC
# MAGIC create or replace view g_na_sm.sm_sales_orders_v as
# MAGIC select
...
# MAGIC   case
# MAGIC     when ol.ansStdUom in ('PR', 'PAIR') then round(ol.quantityOrdered * ol.ansStdUomConv, 2) * 2
# MAGIC     else round(ol.quantityOrdered * ol.ansStdUomConv, 2)
# MAGIC     end quantityOrderedPieces,
# MAGIC   case
# MAGIC     when ol.ansStdUom in ('PR', 'PAIR') then round(ol.quantityOrdered * ol.ansStdUomConv, 2)
# MAGIC     else round(ol.quantityOrdered * ol.ansStdUomConv, 2) / 2
# MAGIC   end quantityOrderedPair,  
...
# MAGIC   round(ol.pricePerUnit *  ol.quantityInvoiced / oh.exchangeSpotRate, 2) invoicedAmountUsd
# MAGIC from
...
# MAGIC
# MAGIC create or replace view g_na_sm.sm_users_v as
# MAGIC  select
# MAGIC firstName,
# MAGIC lastName,
# MAGIC fullName,
...
# MAGIC %sql
# MAGIC create or replace view g_na_sm.edi_sales_orders_v AS
# MAGIC select
# MAGIC   oh.ordernumber,
...
# MAGIC %sql
# MAGIC CREATE OR REPLACE VIEW g_na_sm.sm_product_orgs_v 
# MAGIC AS
# MAGIC select
# MAGIC   itemId,
# MAGIC   item_ID,
...
# MAGIC %sql
# MAGIC CREATE OR REPLACE VIEW g_na_sm.sm_customer_location_v AS
# MAGIC select
# MAGIC   _ID,
